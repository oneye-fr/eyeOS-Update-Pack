...
function eyeBoard ($eyeapp, $appinfo) {
  ...
  if (USR == ROOTUSR) {
    ...
    addActionBar ("<a href='?eraseall=1'><img class='imgbar' border='0' alt='"._L('Erase all messages')."' title='"._L('Erase all messages')."' src='".findGraphic('','delete.png')."'></a>");
    addActionBar (" <a href='?archive=1'><img class='imgbar' border='0' alt='"._L('Archive')."' title='"._L('Archive')."' src='".findGraphic('','save.png')."'></a>");
  }
