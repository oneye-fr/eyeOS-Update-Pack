...
case 'save':
 if (isset ($_REQUEST['elm1'])) {
  $title = empty ($_REQUEST['notetitle']) ? _L('Untitled Document') : $_REQUEST['notetitle'];
...
<div style='position:absolute; top: -18px; left:-1px; height:18px; width:13px;'></div>
...
echo "</div>
   <div class='bubblecancel' style='margin-top: -3px;'>
     <a href='#' onClick=\"javascript:document.getElementById('open').style.display='none';\"><img border='0' alt='"._L('Cancel')."' title='"._L('Cancel')."' src='".findGraphic('','cancelwin.png')."' /></a>
    </div>
</div>
";
...
<br />
 ...
 </select> &nbsp;&nbsp; <input style='border: 0; background-color: transparent; color: #929292;' TYPE='image' SRC='".findGraphic('','upload.png')."' />
 </div>
   <div class='bubblecancel' style='margin-top: -3px;'>
     <a href='#' onClick=\"javascript:document.getElementById('savedoc').style.display='none';\"><img border='0' alt='"._L('Cancel')."' title='"._L('Cancel')."' src='".findGraphic('','cancelwin.png')."' /></a>
    </div>
</div>
";
...
addActionBar("<a href='desktop.php?a=$eyeapp'>
  <img class='imgbar' border='0' alt='"._L('New note')."' title='"._L('New note')."' src='".findGraphic('','new.png')."' \>
 </a>");
addActionBar("<a href='#' onClick=\"javascript:document.getElementById('open').style.display='block';\">
  <img class='imgbar' border='0' alt='"._L('Open note')."' title='"._L('Open note')."' src='".findGraphic('','open.png')."'>
 </a>");
addActionBar("<a href='#' onClick=\"javascript:document.getElementById('savedoc').style.display='block';\">
  <img class='imgbar' border='0' alt='"._L('Save this document')."' title='"._L('Save this document')."' src='".findGraphic('','save.png')."'>
 </a>");
