...
/*                              eyeOS project
   ...
   if (!isset ($_SESSION['usr'])) {
      session_destroy ();
      if (USEDEMO != "yes") include 'index.php';
      elseif (USEDEMO == "yes") header("Location: index.php");
      exit;
   }
   ...
   echo "<div class='panel'></div>
    <div class='botosortir'>
      <img 
        ...
        border='0' 
        src='".findGraphic('desktop','exit.png')."'
        style='cursor:pointer;'
        onclick='closeAll ()'
        />
    </div>
    <div class='rlltg Gclock' Gclock='format:%H:%i;'></div>";
