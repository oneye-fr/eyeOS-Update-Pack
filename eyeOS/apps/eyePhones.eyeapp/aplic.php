...
";
addActionBar("<a href='desktop.php?a=$eyeapp&type=manage'><img class='imgbar' alt='"._L('New contact')."' title='"._L('New contact')."' border='0' src='".findGraphic ('', "btn/new.png")."'></a>");
...
echo "<table width='90%' border='0'>";
  ...
  while ($arx = readdir($directori)) {
    ...
    echo "<tr>
<td><a href='desktop.php?a=$eyeapp&type=manage&edit=$arxd'><img style='position:relative; top: 2px;' alt='"._L('Edit contact')."' title='"._L('Edit contact')."' border='0' src='".$appinfo['appdir']."gfx/contact.png'><strong>
" . @$contactread['surname'] . "</strong>, " . @$contactread['name'] . "</a></td>
<td>" . @$contactread['home_number'] . "</td>
<td align='right'><a href='desktop.php?a=$eyeapp&type=manage&edit=$arxd'><img border='0' src='".findGraphic ('', "btn/edit.png")."'></a> <a onclick='return deleteAlert()' href='desktop.php?a=$eyeapp&nomxesb=$arxd'><img border='0' src='".findGraphic ('', "btn/delete.png")."'></a>
</td>
</tr>";
    }
  }
...
case "manage":
 addActionbar ("<a href='?a=$eyeapp'><img class='imgbar' border='0' alt='"._L('Go Back')."' title='"._L('Go Back')."' src='".findGraphic ('', "btn/back.png")."' /></a>");
 addActionbar ("<div style='position: absolute; top: 4px; left: 32px;'><form name='agregar' method='post' action='desktop.php?a=$eyeapp'><input style='border: 0;  background-color: transparent; color: #929292;' TYPE='image' SRC='".GFXDIR."btn/save.png'></div>");
