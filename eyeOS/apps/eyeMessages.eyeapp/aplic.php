...
function eyeMessages ($eyeapp, &$appinfo) {
  ...
  //Sending message
   ...
   if (isset ($_REQUEST['msgveure'])) { // (View message)	
      ...
      <img class='imgbar' border='0' alt='"._L('Delete message')."' title='"._L('Delete message')."' src='".findGraphic ('', "btn/delete.png")."' />
    </a>");
	 ...
	 $editable = $msginfo['type'] != 'msg';
	    addActionbar ("       
    <a href='?a=$eyeapp'>
      <img class='imgbar' border='0' alt='"._L('Show messages')."' title='"._L('Show messages')."' src='".findGraphic ('', "btn/back.png")."' />
    </a>");
	 echo "
  <div align='center'>
    <form action='desktop.php' method='post'>
      <h2>${msginfo['title']} - <a href='desktop.php?a=$eyeapp&enviarmsg&enviarusr=${msginfo['from']}&enviarrep=".rawurlencode("Re: ".$msginfo['title'])."'>Reply</a></h2>
      ".(($msginfo['type'] == 'msg') ?
...
<form id='enviarmsg' action='desktop.php?a=$eyeapp' method='post'>
  <div align='left' style='margin-left: 30px;'> 
    "._L('To')." : <input type='text' name='desti' size=52' value='$selected' /><br />
    "._L('Subject')." :
...
";
    ...
    <a href='?a=$eyeapp&enviarmsg'>
      <img class='imgbar' border='0' alt='"._L('New Message')."' title='"._L('New Message')."' src='".findGraphic ('', "btn/new.png")."' />
    </a>");
  ...
  <table align='center' width='90%' cellspacing='0'>
    <tr align='left' valign='bottom'>";
         ...
         $sortimg = "<img border='0' src='".findGraphic('b', ($_REQUEST['msort']{0}=='-') ? 'btn/sortUp.png' : 'btn/sortDn.png')."' />";
    ...
    <tr valign='top' class='message ".(($row++ % 2) ? 'oddrow' : 'evenrow')."'>";
	  ...
	  <img class='imgbar' border='0' src='".findGraphic ('', "btn/delete.png")."'>
	</a>";
                  echo "
      </td>";
                  break;
