  ...
  var 
    ...
    caltable = "<table class='cal' cellpadding='1' cellspacing='2'><tr>" +
      (weekno ? "<th class='Cal weekno'></th>" : "") + 
       "<th width='2' class='cal next' style='cursor:pointer;' onmousedown='eyeCal.month (this, "+(m-1) + ", 0)' onmouseup='eyeCal.month (this, "+(m-1) + ", 1)'><img border='0' src='system/gfx/btn/back.png'></th>"+
      "<th class='cal month' colspan='5'>" + eyeCalString.mname[m] + " " + y + "</th>"+
      "<th width='2' class='cal prev' style='cursor:pointer;'  onmousedown='eyeCal.month (this, "+(m+1)+", 0)' onmouseup='eyeCal.month (this, "+(m+1)+", 1)'><img border='0' src='system/gfx/btn/next.png'></th>"+
    "<tr>";
